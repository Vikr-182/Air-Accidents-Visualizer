...
d3.csv("../stack.csv", function (data) {
    ...
    g.selectAll(".bar")
        ...
        .attr("y", function (d) { console.log("for one"); return yScale(+eval("d.X" + yr) + +eval("d.Y" + yr) + +eval("d.R" + yr)); })
        .attr("width", xScale.bandwidth())
        .attr("height", function (d) { return height - +yScale(eval("d.R" + yr)); })
    ...
    gg.data(data)
        ...
        .attr("width", xScale.bandwidth())
        .attr("height", function (d) { return height - yScale(eval("d.Y" + yr)); })
        .on("mouseover.one", function (d) {
    ...
    ggg.data(data)
        ...
        .attr("width", xScale.bandwidth())
        .attr("height", function (d) { return height - yScale(eval("d.X" + yr)); })
        .on("mouseover.one", function (d) {
