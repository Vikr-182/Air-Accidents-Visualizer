...
sortedfinal = {k: v for k, v in sorted(final.items(), key=lambda item: item[1]['total'],reverse=True)}
...
#        print(i+","+str(final[i]['total'])+","+str(final[i]['fatal'])+","+str(0))
        print(i+","+str(final[i]['total']-final[i]['fatal'])+","+str(final[i]['fatal'])+","+str(0))
