...
var margin8 = {top: 10, right: 10, bottom: 10, left: 10},
    width8 = 1000 - margin8.left - margin8.right,
...
d3.json("../../data/loca.json", function(error, graph) {
  ...
  node8
    .append("rect")
      ...
      .style("fill", function(d) { return d.color = color8(d.name.replace(/ .*/, "")); })
  ...
  // add in the title for the nodes
    node8
      .append("text")
        ...
        .attr("transform", null)
        .text(function(d) { return d.name; })
      .filter(function(d) { return d.x < width8 / 2; })
